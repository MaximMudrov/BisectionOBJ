...
DelaunayTriangulation::DelaunayTriangulation()
{
	...
	_ProjectedDots = new vector<Point*>();
...
vector<tuple<int, int, int>*> DelaunayTriangulation::GetTriangulationResult(vector<Point*>& dots)
{
	_Statistics[2] = clock();
	...
	{
		Point* projectedDot = new Point((*itDots), VECTOR_LENGTH);
...
void DelaunayTriangulation::BuildInitialHull(vector<Point*>* dots)
{
	Point* initialVertices[INIT_VERTICES_COUNT];
...
void DelaunayTriangulation::InsertDot(Point* dot)
{
	double det[] = { 0, 0, 0 };
...
void DelaunayTriangulation::SplitTriangle(Triangle* triangle, Point* dot)
{
...
double DelaunayTriangulation::GetDistance(Point* v0, Point* v1)
{
...
double DelaunayTriangulation::GetDeterminant(Point* v0, Point* v1, Point* v2)
{
	double matrix[] = {
		v0->X, v0->Y, v0->Z,
		v1->X, v1->Y, v1->Z,
